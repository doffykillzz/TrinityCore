...
{
	//      x          y         z      o   map
	{ 530, -2278.14f, 5568.74f, 66.9998f, 5.990100f }, // Mall
																//Kalimdor 1 - 22
...
public:
	...
	void OnGossipSelect(Player* player, Item* item, uint32 /*sender*/, uint32 action)
	{
		...
		case 310000: //Custom Dungeon
			AddGossipItemFor(player, 0, "|TInterface\\icons\\achievement_boss_chiefukorzsandscalp:20|tZul Farrak", GOSSIP_SENDER_MAIN, 310002);
	        AddMainMenuGossipItem(player);
       ...
       case 330000: // super instances
		...
		case 310002://Zul Farrak
			player->TeleportTo(1, -6806.850098f, -2890.600098f, 8.886810f, 6.257260f);
			break;
		...
		case 8://Worldboss
			...
			AddGossipItemFor(player, 0, "|TInterface\\icons\\achievement_boss_illidan:20|tposeidon", GOSSIP_SENDER_MAIN, 100002);
            AddGossipItemFor(player, 0, "|TInterface\\icons\\achievement_boss_illidan:20|tIllidan", GOSSIP_SENDER_MAIN, 100003);
			AddMainMenuGossipItem(player);
			player->PlayerTalkClass->SendGossipMenu(DUNGEONS, item->GetGUID());
			break;
